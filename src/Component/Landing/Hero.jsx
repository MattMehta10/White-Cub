...
const Home = () => {
  ...
  return (
    <div className='bg-gradient-to-r  from-[#fab6d9] relative via-[#ff9cb5] to-[#f33a68] overflow-hidden w-full h-screen'>
      ...
      className='absolute top-40 flex flex-col w-130 items-center left-30'>
        ...
        <div className='flex items-center gap-5'>
          <hr className='w-20 border text-white' /><p className='text-bold text-xl text-[#a43890]'>Consciously Vegan</p><hr className='w-20 border text-white' />
          </div>
          <p className='font-medium text-center text-[#511d47] text-xl mt-9 '>India’s pioneering brand for dairy-free, cholesterol-free <br /> indulgence—crafted for every compassionate choice.</p>
    <button className="mt-8 px-6 py-2 relative overflow-hidden bg-white rounded-xl text-[#511d47] font-bold">
      Explore Products
      </button>
      </motion.div>
    ...
    <p className='absolute bottom-55 text-[#a43890] left-60 text-2xl font-extrabold font-[gilroy]'>For your healthier Tomorrow!</p>
  </div>
  )
}
